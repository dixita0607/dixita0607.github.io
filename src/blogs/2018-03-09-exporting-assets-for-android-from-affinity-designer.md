...
![App Home](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/1-app-home.png)
...
![Affinity's export persona](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/2-affinity-export-persona.png)

**Step 2:** Go to the Slices panel in the right pane.

![Affinity's slices panel](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/3-affinity-slices-panel.png)
...
![Layers to be sliced](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/4-layers-to-be-sliced.png)
...
![Slices](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/5-slices.png)
...
![Sliced layers](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/6-sliced-layers.png)

**Step 5:** Expand a slice by clicking an arrow in the left side and set the file path.

![Expand slice](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/7-expand-slice.png)
...
![Drawable MDPI back button](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/8-drawable-mdpi-back_button.gif)
...
![All slices with respective folders](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/9-all-slices.png)
...
![Create android preset](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/10-create-android-preset.gif)

Now we are ready to select the rest of the slices and apply the Android preset on them. 🙌

![Apply android preset](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/11-apply-android-preset.gif)
...
![Exported icons](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/12-exported-icons.png)
...
![Continuous](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/13-continuous.png)

Now whenever you save your changes, exported assets will be updated continuously. Isn't it cool 😎?

![Continuous export](../../assets/images/blogs/2018-03-09-exporting-assets-for-android-from-affinity-designer/14-continuous-export.gif)
